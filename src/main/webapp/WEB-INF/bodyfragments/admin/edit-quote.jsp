						...
						<div class="input">
							...
							<select name="category" 
								...
								<c:forEach items="${categoryList }" var="category">
									<option value="${category.id }" ${quoteDto.checkCategory(category.id) ? "selected" : "" }>${category.name }</option>
								</c:forEach>
							</select>
						</div>
					</td>
						...
						<div class="input">
							...
							<select name="author" >
								<c:forEach items="${authorList }" var="author">
									<option value="${author.id }" ${quoteDto.author.id == author.id ? "selected" : "" }>${author.fullname }</option>
								</c:forEach>
							</select>
						</div>
					</td>
